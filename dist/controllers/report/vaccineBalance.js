...
exports.getVaccineInventoryBalance = void 0;
const db_1 = __importDefault(require("../../db"));
// Endpoint for getting the balance of every vaccine in the inventory
const getVaccineInventoryBalance = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
    ...
    `;
        const balanceResult = yield db_1.default.query(balanceQuery);
...
exports.getVaccineInventoryBalance = getVaccineInventoryBalance;
